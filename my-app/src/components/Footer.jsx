import React from "react"; //Jag importerar React
...
const Footer = () => {
  ...
  //Jag ger constanten handleClickProducts en arrow-function som nyttjar navigate och ger den då sökvägen till alla produkter med react-router-dom funktionen useNavigate
  ...
  return (
    ...
    <main>
      <section id="footerBack">
        ...
        <button id="allProductsBtn" onClick={handleClickProducts}>
          PRODUKTER
        </button>
      </section>
    </main>
